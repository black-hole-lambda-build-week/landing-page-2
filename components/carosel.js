...
let socialData = {
  amanda: [],
  matthew: ['https://github.com/moddamatt', 'https://www.linkedin.com/in/mattmorganlewis/'],
  javontay: ['https://github.com/javontaymcelroy','https://www.linkedin.com/in/javontay-mcelroy-663b81bb/'],
  alex: [],
  will: ['https://github.com/brellin', 'https://www.linkedin.com/in/brellin/'],
  curtis: ['https://github.com/Chubbard022', 'https://www.linkedin.com/in/curtis-hubbard-945764158/']
};
...
class People {
  constructor(person) {
      ...
      this.person.style.background = `linear-gradient( rgba(0, 0, 0, 0.25), rgba(50, 50, 50, 0.45)), url('assets/headshots/${this.data}.jpg') scroll no-repeat center / contain`;
  }
}
...
member.forEach(per => new People(per));
member.forEach(per => new Plinks(per));
